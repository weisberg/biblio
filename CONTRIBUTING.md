...
Thanks for being here! Biblio is still early, and every bug report, idea, and contribution genuinely helps shape the app.
...
- 🐛 Bugs → GitHub Issues
- 💡 Feature requests / ideas → Canny • <https://biblio.canny.io/>
...
- Follow the dev process described in Biblio’s `AGENTS.md` (tests, code health, etc.)
- Avoid bundling unrelated refactors into the same PR

If you want to contribute a feature, the best place to start is here: <https://biblio.canny.io/>
...
Biblio is getting better because people care enough to try it, report what’s broken, suggest what’s missing, and contribute improvements.
