...
const EN_TRANSLATIONS = {
  ...
  'settings.sync.description': 'Configure background pulling and which update feed Biblio follows. Stable only receives manually promoted releases, while Alpha follows every push to main.',
  ...
  'settings.appearance.description': 'Choose the app color mode used for Biblio chrome, editor surfaces, menus, and dialogs.',
  'settings.theme.label': 'Theme',
  'settings.theme.light': 'Light',
  'settings.theme.dark': 'Dark',
  'settings.language.title': 'Language',
  'settings.language.description': 'Choose the display language for Biblio chrome. System follows macOS when that language is supported, with English as the fallback.',
  ...
  'settings.autogit.enableDescription': 'When enabled, Biblio will commit and push saved local changes automatically after an idle pause or after the app becomes inactive.',
  ...
  'settings.titles.description': 'Choose whether Biblio automatically syncs untitled note filenames from the first H1 title.',
  'settings.titles.autoRename': 'Auto-rename untitled notes from first H1',
  'settings.titles.autoRenameDescription': 'When enabled, Biblio renames untitled-note files as soon as the first H1 becomes a real title. Turn this off to keep the filename unchanged until you rename it manually from the breadcrumb bar.',
  'settings.aiAgents.title': 'AI Agents',
  'settings.aiAgents.description': 'Choose which CLI AI agent Biblio uses in the AI panel and command palette.',
  ...
  'settings.workflow.description': 'Choose whether Biblio shows the Inbox workflow, plus how it moves through items while you triage them.',
  ...
  'settings.privacy.description': 'Anonymous data helps us fix bugs and improve Biblio. No vault content, note titles, or file paths are ever sent.',
...
const ZH_HANS_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'settings.sync.description': '配置后台拉取以及 Biblio 使用的更新通道。Stable 只接收手动推广的版本，Alpha 跟随 main 的每次推送。',
  'settings.pullInterval': '拉取间隔（分钟）',
  'settings.releaseChannel': '发布通道',
  'settings.releaseStable': 'Stable',
  'settings.releaseAlpha': 'Alpha',
  'settings.appearance.title': '外观',
  'settings.appearance.description': '选择 Biblio 界面、编辑器、菜单和对话框使用的颜色模式。',
  'settings.theme.label': '主题',
  'settings.theme.light': '浅色',
  'settings.theme.dark': '深色',
  'settings.language.title': '语言',
  'settings.language.description': '选择 Biblio 界面的显示语言。系统选项会在支持时跟随 macOS，否则回退到英文。',
  ...
  'settings.autogit.enableDescription': '启用后，Biblio 会在空闲暂停或应用变为非活跃后自动提交并推送保存的本地更改。',
  'settings.autogit.idleThreshold': '空闲阈值（秒）',
  'settings.autogit.inactiveThreshold': '应用非活跃宽限期（秒）',
  'settings.titles.title': '标题与文件名',
  'settings.titles.description': '选择 Biblio 是否根据第一个 H1 标题自动同步未命名笔记的文件名。',
  'settings.titles.autoRename': '根据第一个 H1 自动重命名未命名笔记',
  'settings.titles.autoRenameDescription': '启用后，只要第一个 H1 成为真实标题，Biblio 就会重命名 untitled-note 文件。关闭后，文件名会保持不变，直到你从面包屑栏手动重命名。',
  ...
  'settings.workflow.description': '选择 Biblio 是否显示 Inbox 工作流，以及整理时如何移动到下一项。',
  ...
  'settings.privacy.description': '匿名数据可帮助我们修复错误并改进 Biblio。不会发送仓库内容、笔记标题或文件路径。',
